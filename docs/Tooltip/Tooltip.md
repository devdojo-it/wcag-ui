...
<div id="tip-1" role="tooltip" hidden>Help text.</div>
```
...
<div id="help-tip" role="tooltip" hidden>The code is reported in the "Details" section.</div>
```
...
<div id="tip-2" role="tooltip" hidden>Supporting information.</div>
```
