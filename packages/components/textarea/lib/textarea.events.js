...
export default {
  input: function (e) {
    console.log('textarea emitted input', this.ariaLabel);
  ...
  change: function (e) {
    console.log('textarea emitted change', this.ariaLabel);
  ...
  focus: function (e) {
    console.log('textarea emitted focus', this.ariaLabel);

    events.dispatchComponentEvent.call(this, 'focus', { value: this.value }, e);
  },
  blur: function (e) {
    console.log('textarea emitted blur', this.ariaLabel);

    events.dispatchComponentEvent.call(this, 'blur', { value: this.value }, e);
  },
  invalid: function (e) {
    console.log('textarea emitted invalid', this.ariaLabel);
